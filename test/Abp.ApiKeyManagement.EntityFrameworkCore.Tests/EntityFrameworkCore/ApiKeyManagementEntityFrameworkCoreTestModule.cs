...
public class ApiKeyManagementEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        new ApiKeyManagementDbContext(
            new DbContextOptionsBuilder<ApiKeyManagementDbContext>().UseSqlite(connection).Options
